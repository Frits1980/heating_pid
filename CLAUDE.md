...
- `store.py` - JSON persistence in `.storage/ems_zone_master.json` for learned warmup factors and PID integrals
...
```
custom_components/ems_zone_master/
...
ha core logs | grep ems_zone_master
